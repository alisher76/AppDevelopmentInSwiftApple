...
songsList.append("Hey You Beautiful")
songsList.insert("Yayaya in Miami", at: 1)
songsList += ["Yo my name is Shady"]
songsList.append("Lose yourself")
songsList.count
...
var enthusiasticSinger = ["Malama", "Malama222", "Malama23232"]
...
print("Hey guys next song is \(song) so get ready yo")
}
