...
var chickenOfHilariouCount = 0
var chickenOfFriendlyCount = 0
var chickenOfOtherCount = 0

for chicken in chickens {
    if chicken.temper == .hilarious {
    chickenOfHilariouCount += 1
    }else if chicken.temper == .friendly{
    chickenOfFriendlyCount += 1
    }else{
    chickenOfOtherCount += 1
    }

}
print("friendly chickens: \(chickenOfFriendlyCount), Hilarious Chickens: \(chickenOfHilariouCount), other types: \(chickenOfOtherCount)")
