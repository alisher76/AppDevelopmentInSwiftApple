...
let something = impossibleBeliefsCount(pigsFlying: 10, frogsBecomingPrinces: 20, multipleLightningStrikes: 23)
impossibleThingsPhrase(numberOfImpossibleThings: something, meal: "Sushi")
