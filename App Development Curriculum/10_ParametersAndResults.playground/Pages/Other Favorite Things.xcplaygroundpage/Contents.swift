...
*/
func otherFavFood(categoryOfThing: String, favorite: String){
print("My favorite food is \(categoryOfThing) and \(favorite)")
}

otherFavFood(categoryOfThing: "FastFood", favorite: "Burger")
